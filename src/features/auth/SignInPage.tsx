...
export function SignInPage() {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "28px 40px" }}>
        <Link to="/" className="flex items-center gap-2 no-underline" style={{ width: "fit-content" }}>
          <div style={{ width: 34, height: 34, borderRadius: 10, background: "linear-gradient(135deg, #7C3AED 0%, #FF2E9A 100%)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Zap size={18} color="white" fill="white" />
          </div>
          <span style={{ fontWeight: 700, fontSize: 20, color: "#F5F3FF" }}>FrameFlow</span>
        </Link>
      </div>
